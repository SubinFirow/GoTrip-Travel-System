  ...
  render() {
    return (
      <div>
          ...
          <div id="content-bod" className="card">
            <div className="row">
              ...
              <div className="col-lg-6">
                ...
                >
                  <h2>
                    <strong>Plan Your Own Trip</strong>
                  </h2>
                  <br />
                  <div className="row">
                    <div className="col-lg-6">
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <label htmlFor="picplace">
                        <small>Pick-up Place</small>
                      </label>
                      <input
                        type="text"
                        className="form-control"
                    ...
                    <div className="col-lg-6">
                      <label htmlFor="start">
                        <small>Interesting Place to visit</small>
                      </label>
                      <input
                        type="text"
                        className="form-control"
        ...
        <br></br>
        <p class="text-center">
          Whether you want to modify a tour package on our website or have an
          itinerary built from scratch, the local travel consultants at GoTrip
          can create your ideal trip. In addition to the benefits of all our
          tours - booking handpicked hotels, transportation, excursions and more
          - customized tours offer a personalized experience. You decide where
          to visit, how long to spend and what type of accommodation suits you
          best. Let us know what we can do for you by completing the form below.
          Please provide as many details as possible, even estimates are
          helpful.
        </p>
        <br></br>
        {/* <div className="row">
