...
class Home extends Component {
  ...
  componentDidMount() {
    if (this.state.city === "") {
      ...
      axios
        .get("http://localhost:4000/hotel/search/" + this.state.city)
        .then((response) => {
              ...
              <div key={hotel.hotelName}>
                <div className="card d-block" id="hotelcard">
                  <img
                    ...
                    src={"http://localhost:4000/uploads/" + hotel.hotelImage}
                    alt="Hotel Avatar: "
                  />
                  <br />
                  <div className="card-body" id="detailshome">
                    ...
                    <span>
                      {" "}
                      Location: <span>{hotel.place}</span>
                    </span>
                    <br />
                    {hotel._id}
          ...
          <div id="content-bodyy" className="card">
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                ...
                >
                  <h2>
                    <strong>Find the perfect place to stay</strong>
                  </h2>
                  <br />
