...
class Vehicle extends Component {
  ...
  vehicleBook() {
    ...
    axios
      .get(
        "http://localhost:4000/vehicle/search/" +
          this.state.size +
          "/" +
          this.state.picklocation
      ) //check vehicle only or vehicle with driver
      .then((response) => {
        console.log("didmount");
        let vehicles = response.data.map(
          (vehicle) => {
              ...
              <div key={vehicle._id}>
                <div className="card d-block" id="vehiclecard">
                  <img
                    ...
                    src={
                      "http://localhost:4000/uploads/" + vehicle.vehicleImage
                    }
                    alt="Vehicle Avatar: "
                  />
                  <br />
                  <div className="card-body" id="detailsvehi">
                    <span>
                      {" "}
                      Vehicle Owner: <span>{vehicle.vehicleOwner}</span>
                    </span>
                    <br />
                    <span>
                      {" "}
                      Vehicle Model: <span>{vehicle.vehicleModel}</span>
                    </span>
                    <br />
                    <span>
                      {" "}
                      Location: <span>{vehicle.locations}</span>
                    </span>
                    <br />
          ...
          <div id="content-bodyyy" className="card">
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                ...
                >
                  <h2>
                    <strong>Find your ideal Vehicle to travel</strong>
                  </h2>
                  <br />
                  <div className="form-group">
                    <input
                  ...
                  <div className="form-group">
                    <div className="col-lg-6">
                      ...
                      />
                      Drop-off from different location
                    </div>
                    {content}
                  </div>
                  <div className="row">
                    ...
                    <div className="col-lg-6">
                      <label className="radio-inline">
                        <input
                          ...
                          value="driver"
                          name="size"
                          checked={this.state.size === "driver"}
                          onChange={this.onChange}
                        />
                        With Driver
                      </label>
                      ...
                      <label className="radio-inline">
                        <input
                          ...
                          value="nodriver"
                          name="size"
                          checked={this.state.size === "nodriver"}
                          onChange={this.onChange}
                        />
                        Only Vehicle
                      </label>
        ...
        <div className="row">
          <div className="col-lg-4">
            ...
            <h5 class="text-center">
              You can take online payments or pre-payments, we offer more than
              70 payment gateways.
            </h5>
          </div>
          <div className="col-lg-4">
            ...
            <br></br>
            <h5 class="text-center">
              You can set up pick-up/drop-off locations and GoTrip will even
              find the nearest offer.
            </h5>
          </div>
          <div className="col-lg-4">
            <h3 className="text-center">
            ...
            <br></br>
            <h5 class="text-center">
              GoTrip will be able to reflect your pricing model however complex
              it may be.
            </h5>
            <br></br>
          </div>
